...
int main()
{
    ...
    do {
        ...
        case 1: { //заповнення дерева з існуючого файлу
            ...
            {
                printf("Ідентифікаційний код елемента в файлі не відповідає розміру в 10 елементів!\n");
                if (freeStruct(dAK, counter) == -1) /*звільнення пам'яті для масиву структурного типу і перевірка*/
                {
                    printf("Масиву структурного типу не існує!\n");
                    exit(0);
        ...
        case 2: { //створення нового файлу
            printf("Введіть назву файлу у вигляді name.bin для подальшої роботи з ним:\n");
            checkFilename(filename); //перевірка правильності введення назви файла
            break;
        }
...
0)Завершити програму;\n");
        ...
        case 1: //виведення на екран елементу
        {
            ...
            printf("Введіть ключ(ідентифікаційний код з 10 символів) елемента дерева, який бажаєте вивести на екран:\n");
        ...
        case 2: //вставлення елемента в дерево
        {
            ...
            printf("Введіть ключ(ідентифікаційний код з 10 символів), елемент з яким бажаєте вставити в дерево:\n");
            keyScan(forKey); //зчитування введеного з клавіатури ключа
        ...
        case 3: //виключення елемента з дерева
        {
            ...
            printf("Введіть ключ(ідентифікаційний код з 10 символів), елемент з яким бажаєте виключити з дерева:\n");
            keyScan(forKey); //зчитування введеного з клавіатури ключа
...
int keyUsingSearch(BTNode* tree, char* key, int* noElementCheck) {
    if (tree != NULL) { /*якщо вершина існує*/
        ...
        keyUsingSearch(tree->left, key, noElementCheck); /*"пірнаємо" в ліве піддерево вузла*/
        keyUsingSearch(tree->right, key, noElementCheck); /*"пірнаємо" в праве піддерево вузла*/
    }
    return *noElementCheck;
}
